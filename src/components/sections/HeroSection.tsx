...
export default function HeroSection() {
  return (
    <section className="relative overflow-hidden bg-white py-20 sm:py-28">
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute -top-40 right-0 h-[600px] w-[600px] rounded-full opacity-10 bg-[radial-gradient(circle,#7C3AED_0%,transparent_70%)]"
      />
      ...
      <div className="relative mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
        ...
        <h1 className="text-5xl font-bold leading-tight tracking-tight text-foreground sm:text-6xl">
          ...
          <span className="text-primary">pour faire vivre</span>{' '}
